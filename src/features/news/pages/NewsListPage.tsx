    ...
    return (
        <>
            ...
            <main className="min-h-[80vh] bg-[#faf7f2] pb-24 mt-[88px] md:mt-[120px]">
                ...
                <div ref={newsSectionRef} className="mx-auto max-w-[1200px] px-6 pt-1">
                    {/* Page Header */}
                        ...
                        <>
                            ...
                            {totalPages > 1 && (
                                <div className="mt-12 flex flex-col items-center gap-4">
                                    <div className="flex items-center gap-2 font-['Cormorant_Garamond',_Georgia,_serif]">
                                        <button
                                            onClick={() => handlePageChange(currentPage - 1)}
                                            disabled={currentPage === 1}
                                            className="px-3.5 py-1.5 rounded-[2px] border border-[#ede0c4] bg-white text-xs font-semibold uppercase tracking-wider text-[#2c1a00] transition-all hover:bg-[#2c1a00] hover:text-[#c4a84f] hover:border-[#2c1a00] disabled:opacity-40 disabled:cursor-not-allowed disabled:hover:bg-white disabled:hover:text-[#2c1a00] disabled:hover:border-[#ede0c4]"
                                        >
                                            ‹ Trang trước
                                        </button>
                                    ...
                                    <span className="text-xs text-[#888] font-['Cormorant_Garamond',_Georgia,_serif] tracking-wider">
                                        Hiển thị {startIndex + 1} - {Math.min(startIndex + ITEMS_PER_PAGE, articles.length)} trên tổng số {articles.length} bài viết
                                    </span>
                                </div>
                            )}
                        </>
