                        ...
                        {[
                            ...
                            <div key={key} className="relative w-full">
                                ...
                                <button
                                    ...
                                    className="absolute right-3 top-[32px] p-1 border-none bg-transparent cursor-pointer text-gray-400 hover:text-[#c4a84f] transition-colors flex items-center justify-center"
